...
mueve1x			ldr r0,=dir1x
				strb r1,[r0]
				
				; inicar direccion jugador 2
mueve1y				PUSH{pc}
				bl srand
				add sp,sp,#4			; liberar parametros
				bl rand
...
bucle  			ldr r1,[r0]				; r1=terminar
				...
				bne cambio_dir
				mov r1,#'X'				; r1='X'
				strb r1,[r5]			; inicio_pan+posicion='X'
				ldr r2,=x1				; r2=@x1
				str r3,[r2]				; x1=r3
				ldr r2,=y1				; r2=@x1
				str r3,[r2]				; x1=r3
				...
				; elegir otra direccion
cambio_dir1		ldr r1,=dir1x
				ldr r2,[r1]
				cmp r2,#0
				bne elegir_y
				ldr r3,=dir1y
				...
				ldr r4,=x1				; r2=@x1
				ldr r3,[r4]				; r3=x1
				add r3,r3,r2			; r3=r3+r7 ;x1=x1+dir1x
				and r3,#31				; empieza por el otro lado
				ldr r2,=y1				; r2=@y1
				ldr r4,[r2]				; r4=y1
				LDR r6,=tam_fila		; r6=32
...
elegir y		
				...
				; dibujar jugador 2
dibujar2				LDR r5,=inicio_pan		; r0=@inicio_pan=0x40007E00
