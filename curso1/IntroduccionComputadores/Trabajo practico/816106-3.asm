...
anteriorLetra: .rw 1        ; char letra=0x0000;
...
mov letra, anteriorLetra    ; anteriorLetra = letra;
add const, INST             ;
INST: mov vector, letra     ; letra = vector[i];
cmp espacio, letra          ; if (letra == espacio) {
beq while                   ; }
cmp punto, letra            ; if (letra == punto) {
beq while                   ; }
cmp espacio, anteriorLetra  ; if (anteriorLetra == espacio) {
beq while                   ; }
