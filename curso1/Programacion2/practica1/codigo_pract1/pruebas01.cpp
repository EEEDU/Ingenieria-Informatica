...
int main() {
    ...
    // int numeroCifras = numCifras(numero, base);
    // int cif = cifra(numero, i, base);
    // int cifMay = cifraMayor(numero, base);
    // int cifMasSig = cifraMasSignificativa(numero, base);
    // int sumCif = sumaCifras(numero, base);

    // cout << "El numero es: " << numero << " || en base: " << base << endl;
    // cout << "Numero de cifras es: " << numeroCifras << endl;
    // cout << "La cifra " << i << " es: " << cif << endl;
    // cout << "La cifra mayor es: " << cifMay << endl;
    // cout << "La cifra mas significativa es: " << cifMasSig << endl;
