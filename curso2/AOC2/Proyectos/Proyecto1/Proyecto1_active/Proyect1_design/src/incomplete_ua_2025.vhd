...
-- Example: Jal r1, @jump; @jump: ADD R1, R2, R1; 
	...
	-- COMPLETE:
	-- SOLUCION: 
		-- Siempre y cuando el estado de la instruccion sea valido
		-- Si el RT coincide con RW_MEM y el RegWrite_MEM es 1, entonces se activa la señal Corto_B_Mem.
		-- Si el RS complement con RW_WB y el RegWrite_WB es 1, entonces se activa la señal Corto_A_WB.
		-- Si el RT complement con RW_WB y el RegWrite_WB es 1, entonces se activa la señal Corto_B_WB.
	...
	-- SOLUCION:
		-- Si la señal Corto_A_Mem es 1, entonces el MUX_ctrl_A es 01.
		-- Si la señal Corto_A_WB es 1, entonces el MUX_ctrl_A es 10.
		-- En caso contrario, el MUX_ctrl_A es 00.
		-- Lo mismo para el MUX_ctrl_B.
